...
public:
    ...
    // RJ
		...
		kCTE = kTimeEditor,					//!< Used for backward compatibility
		kAnimLayerClipSingle,				//!< Used for backward compatibility
		kAnimLayerClipRotation,				//!< Used for backward compatibility
		kTimeEditorVisualizer				//!< Used for backward compatibility
	};
